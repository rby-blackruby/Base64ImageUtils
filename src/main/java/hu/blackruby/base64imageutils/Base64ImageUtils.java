...
public final class Base64ImageUtils {
    ...
    public static BufferedImage merge(String base64ImageString1, String base64ImageString2) throws IOException {
        return merge(base64ImageString1, base64ImageString2, MergeDirection.HORIZONTAL);
    }

    public static BufferedImage merge(String base64ImageString1, String base64ImageString2, MergeDirection mergeDirection) throws IOException {
